...
export class ModalService {
	...
	open<C>(component: Type<C>, createModalOptions?: CreateModal) {
		...
		return this.openWithComponent(createModalOptions ?? {}, component) as ComponentRef<C>;
	}

	private getProjectNodes(options: CreateModal, newComponent: ComponentRef<unknown>) {
	...
	private openWithComponent(options: CreateModal, component: Type<unknown>) {
		...
		this.document.body.appendChild(this.newModalComponent.location.nativeElement);
